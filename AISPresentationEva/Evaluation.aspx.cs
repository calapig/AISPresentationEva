...
namespace AISPresentationEva
{
    public partial class Evaluation : System.Web.UI.Page
    {
        ...
        protected void btnSaveDoc_Click(object sender, EventArgs e)
        {
            ...
            string fileName = string.Format(@"D:\{0}-{1}-{2}-{3}-{4}.docx", TxtCourseCode.Text, txtSemester.Text, DateTime.Today.Year.ToString(), TxtStudentID.Text, TxtTopicId.Text);
            var doc = DocX.Create(fileName);


            doc.InsertParagraph("Student Name: " + TxtStudentName.Text + " Student ID: " + TxtStudentID.Text);
